...
global.channelLink = "https://whatsapp.com/channel/0029VbBE8ErLSmbWhLrLkR0v";
global.ytch = "TIEGO";
...
async function handleGroupParticipantUpdate(sock, update) {
    try {
        ...
        if (action === 'add') {
            ...
            const channelId = welcomeData?.channelId || '120363418929897261@newsletter';
        ...
        if (action === 'remove') {
            ...
            const channelId = goodbyeData?.channelId || '120363418929897261@newsletter';
